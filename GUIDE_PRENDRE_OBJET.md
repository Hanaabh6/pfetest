...
```
1️⃣ UTILISATEUR ACCÈDE À recherche.html
   ↓
...
Puis naviguer vers: **http://localhost:5500/recherche.html**

Option B - Direct dans navigateur:
```
Ctrl+O → c:\Users\ASUS\Downloads\projet_smart_building-main\recherche.html
```
...
| ✅ `recherche.html` | 🔄 Remplacé version complète | Ajouter UI + modal + bouton "Prendre" |
| ✅ `config.js` | Utilisé dans recherche.html | Configuration API_BASE |
...
```
1. Admin accède à recherche.html
...
Puis ouvrez `recherche.html` et essayez de "prendre" un objet! 🎉
