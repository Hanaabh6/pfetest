...
┃  🔧 TRIGGER: Clic bouton "Prendre" sur recherche.html    ┃
...
1️⃣ UTILISATEUR EN PAGE
   recherche.html charge → GET /things/search
...
# Browser: http://localhost:5500/recherche.html
...
| recherche.html | 439 | 🔄 remplacé | UI complète |
