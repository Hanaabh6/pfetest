...
def rebuild_keyword_index():
    ...
    try:
        ...
        # Supprimer tout l'index existant pour éviter les entrées orphelines.
        deleted_all = keyword_index_collection.delete_many({})
        print(f"  🧹 {deleted_all.deleted_count} anciennes entrées supprimées")
...
def get_index_statistics():
    ...
    try:
        ...
        for i, item in enumerate(top_things, 1):
            print(f"     {i}. thingId={item['_id']}: {item['count']} mots clés")
