...
from ..populate_keywords import _build_index_docs_for_object
...
def _build_keyword_docs(item: dict) -> list[dict]:
    # Source unique: utilise exactement la meme logique que populate_keywords.rebuild.
    return _build_index_docs_for_object(item)
