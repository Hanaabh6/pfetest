...
2. Étape 2: Ouvrir `recherche.html`
...
| recherche.html | Frontend | 🔄 Remplacé | UI/Dev | 439 L |
...
| "Quelle est l'interface?" | recherche.html |
...
main_crud.py (backend)
    ↓
recherche.html (frontend utilise l'endpoint PATCH)
    ↓
...
- recherche.html doit avoir accès à config.js ✅
